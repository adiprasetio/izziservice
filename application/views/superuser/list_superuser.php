...
<a href="<?php echo base_url();?>superuser/user_add" style="text-decoration:none">Add SUPERUSER</a></div>
						...
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
                           ...
                           <?php $no = 0; foreach($datauser as $row) : $no++;?>
						     <tr>
						        ...
						        <td> 
<a class="ubah btn btn-primary btn-xs" href="<?php echo base_url();?>superuser/user_edit/<?php echo $row->id_user;?>"><span class="glyphicon glyphicon-edit" ></span></a>
