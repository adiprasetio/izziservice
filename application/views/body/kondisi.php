...
<a href="<?php echo base_url();?>kondisi/add" style="text-decoration:none">Add Contidion</a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th data-field="no" data-sortable="true" width="10px"><center> No </center></th>
						        <th data-field="id" data-sortable="true"><center>Condition</center></th>
						        <th data-field="ids" data-sortable="true"><center>Respone Time</center></th>
