...
<a href="<?php echo base_url();?>sub_kategori/add" style="text-decoration:none">Add Sub Category</a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th data-field="no" data-sortable="true" width="10px"><center>No</center></th>
						        <th data-field="id" data-sortable="true"><center>Category</center></th>
						        <th data-field="bagian" data-sortable="true"><center>Sub Category</center></th>
						        <th data-sortable="true"><center>Action</center></th>
						    </tr>
                            </thead>
                            <tbody>
